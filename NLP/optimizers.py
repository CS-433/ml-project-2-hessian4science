    ...
    def set_f(self, model, data, target, criterion):
        if self.has_f:
            ...
            def f(*params):
                ...
                try: # This is in the case you are using a Pretained model as distilbert
                    out = out.logits
                except:
                    pass
...
class SCRN(COptimizer):
    def __init__(self, params, T_out=1, T_eps=10, lr=0.05,
                 rho=1, c_=1, eps=0.001, using_final=False):
...
class SCRN_Momentum(SCRN):
    def __init__(self, params, T_out=1, momentum=0.9, T_eps=15, lr=0.05, rho=1, c_=1, eps=0.001):
